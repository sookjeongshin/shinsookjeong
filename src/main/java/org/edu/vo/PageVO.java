 ...
 * 왜필요하는가? 회원 또는 게시물이 10만건을 한꺼번에 보여주면, 조회속도가 느리게 됩니다.
 * 1페이지당 10개 또는 20개, 30개 등등 제한을 두어서, 속도향상 및 사용자화면을 개선시킵니다.
...
public class PageVO {
	//예를 들면 변수 중에  boolean(일반형데이터형변수) / boolean(대문자로시작-클래스형 변수-Null로 입력되었을때 처리하는 로직이 들어있습니다.)
