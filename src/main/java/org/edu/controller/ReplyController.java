...
/**
 * ReplyController.java 클래스 댓글 구현 REST-API 컨트롤러
 * 
 * @author 신숙정
 * 
 * 
...
public class ReplyController {
	...
	public ResponseEntity<Map<String, Object>> reply_list(@PathVariable("bno") Integer page,
			@PathVariable("bno") Integer bno) throws Exception {
		// 페이징 계산식 처리
	...
	public ResponseEntity<String> reply_write(@RequestBody ReplyVO replyVO) {
		...
		// ResponseEntity<String> result = new ResponseEntity<String>("SUCCESS",
		// HttpStatus.OK);
