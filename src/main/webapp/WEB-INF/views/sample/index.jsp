<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   jsp에서 자바프로그램을 사용할 때 쓰는 태그가 <% %> 감싸주게 됩니다.
    다른언어 PHP 예를들면 <?php ?> 꺾쇠로 감싸주게 됩니다. 
  @ page골뱅이는 애노테이션으로 발음-페이지지시자는 필수입니다. 
    랭귀지 :java, 콘텐츠타입:text/html; 문자셋:유니코드, 페이징인코딩:UTF-8, 자바주석 끝--%>

<!-- HomeController.java 에서 index.jsp로 매칭 시킨 결과가 나오는 페이지 입니다.<br>
- HTML에서는 /resources/sample/index.html 이렇게 접근합니다.<br>
- jsp프로그램에서는 위 html처럼 바로접근 못하고, 홈컨트롤러 자바를 거쳐서 index.jsp를 접근하는 이유는 보안 떄문입니다.<br>
- 그래서 은행, 관공서, 대학에서 대부분 사용합니다. (스프링을 배우는 목적)<br>
- 다른 예로, php프로그램은 위에 있는 html처럼 파일에 바로 접근이 가능합니다.(그래서 일반 중소기업 홈페이지에 사용)<br>
- 출발은 자바(pc용 어플리케이션, 웹프로그램도 만드는데 모두 사용됩니다.)<br>
- 자바에서 출발한 스프링 프레임워크는: 자바에서 웹프로그램 만드는데 특화된 라이브러리(프로그램묶음)를 구조화 시켜놓아서<br>
- 개발자가 편하게 만들어 놓은 것이 스프링프레임워크. (현재는 버전 5.x, 우리는 4.3.22버전 사용예정)<br>
- jsp는 뭐냐: 지금 보이는 프로젝트는 스프링MVC프로젝트 입니다.<br>
- 여기서 말하는 MVC에서 View단에 해당하는 기술부분이 jsp입니다.<br>
