...
.note-editor.note-frame.fullscreen{background:white;}
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<!-- 폼영역 -->
			<form method="POST" name="board_update" action="/home/board/board_update" class="appForm" encType="multipart/from-data">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input value='<c:out value="${boardVO.writer}"/>' type="text" name="name" class="w100p" id="writer_lbl" placeholder="이름을 입력해주세요" required/></div>
						</li>
						<li class="clear">
