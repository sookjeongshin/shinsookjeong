...
<%@ include file="include/header.jsp" %>
      <style>
       	...
       	.length_limit{
		    ...
		    white-space: nowrap; /*줄바꿈 할 때 공백은 포함 안시키는 의미*/
       	}
       </style>
<script>
...
<div id="container">
	...
	<li class="opacity_hover">
						<a href="/home/board/board_view?bno=${boardVO.bno}&page=1">
							<div style="height:270px;overflow:hidden">						<c:if test="${save_file_names[status.index] eq ''}">
	...
	<div class="appbbs_area">
		<div class="appbbs_box box_inner clear">
			...
			<div class="bbs_line">
				...
				<li><a href="/home/board/board_view?bno=${boardVO.bno}&page=1"><c:out value="${boardVO.title}boardVO.title"></c:out></a></li>
				</c:forEach>
				</ul>
			</div>
		</div>
